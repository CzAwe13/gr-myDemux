...
#include <gnuradio/myDemux/my_header_payload_demux.h>

namespace gr {
namespace myDemux {

class my_header_payload_demux_impl : public my_header_payload_demux
{
private:
...
public:
    my_header_payload_demux_impl(const int header_len,
    ...
    ~my_header_payload_demux_impl() override;
